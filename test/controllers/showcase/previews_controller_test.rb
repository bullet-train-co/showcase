...
class Showcase::PreviewsController::IndexTest < Showcase::InternalIntegrationTest
  ...
  test "#index template can be overridden" do
    template_file "showcase/engine/previews/index.html.erb", <<~HTML
...
class Showcase::PreviewsController::ShowTest < Showcase::InternalIntegrationTest
